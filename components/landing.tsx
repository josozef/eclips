...
export function Landing() {
  return (
    <div className="relative min-h-[calc(100vh-66px)] overflow-hidden">
      {/* Background video — full-width behind everything */}
      <video
        autoPlay
        loop
        muted
      ...
      {/* Darken the video so it's subtle */}
      <div className="absolute inset-0 bg-black/90" />

      {/* Center content column with solid black background */}
      <div className="relative z-10 mx-auto min-h-[calc(100vh-66px)] max-w-5xl bg-black px-8 py-12">
        <div className="grid min-h-[calc(100vh-66px-96px)] gap-8 md:grid-cols-2 md:gap-12">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
              EClips makes it easy to upload, organize, and share your gaming
              clips across platforms like Instagram, TikTok, YouTube, and more.
            </p>
